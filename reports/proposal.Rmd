...
The dataset used in this project was sourced from Vancouver Police
Department, and particularly accessed from
[here](https://geodash.vpd.ca/opendata/#). The dataset used for building
dashboard is the 2021 crimes data in all Vancojver neighbourhoods as
